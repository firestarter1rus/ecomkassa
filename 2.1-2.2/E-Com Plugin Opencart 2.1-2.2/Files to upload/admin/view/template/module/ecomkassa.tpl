								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									  ...
									  <select  name="ecomkassa_payment[<?php echo $payment_system['code']; ?>]" class="form-control" />
											<option value="0"><?php echo $ecom_dont_use; ?></option>
											<?php
			...
			<div class="tab-pane" id="tab_about">
				<div class="col-sm-offset-2 col-sm-8">
					...
					<div class="row" style="margin-top:50px;">
						<div class="col-sm-3">
						<a href="www.ecom.ru"><img src="/admin/view/image/ecomkassa/ecom.png" class="img-responsive" style="margin:25px;margin-top:0px;max-width:150px;"></a>
						</div>
						<div class="col-sm-9">
					...
					<div class="row"  style="margin-top:50px;">
						<div class="col-sm-3">
						<a href="mad-studio.ru"><img src="/admin/view/image/ecomkassa/mad.png"  class="img-responsive"  style="margin:20px;max-width:150px;"></a>
						</div>
						<div class="col-sm-9">
