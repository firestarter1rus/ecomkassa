...
class ControllerExtensionModuleEcomkassa extends Controller { 
	...
	public function index() {
		$this->load->language('extension/module/ecomkassa');
		...
		$data['check_url'] = $this->url->link('extension/module/ecomkassa/check', 'user_token=' . $this->session->data['user_token'], 'SSL');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/ecomkassa', 'user_token=' . $this->session->data['user_token'], 'SSL')
		);

		$data['action'] = $this->url->link('extension/module/ecomkassa', 'user_token=' . $this->session->data['user_token'], 'SSL');

		$data['cancel'] = $this->url->link('extension/module', 'user_token=' . $this->session->data['user_token'], 'SSL');
		
		if (isset($this->request->post['module_ecomkassa_url'])) {
			$data['url'] = $this->request->post['module_ecomkassa_url'];
		} else {
			$data['url'] = $this->config->get('module_ecomkassa_url');
		}
		if(empty($data['url'])){
			$data['url'] = 'https://app.ecomkassa.ru/fiscalorder/v2';
		}
		
		if (isset($this->request->post['module_ecomkassa_sno'])) {
			$data['sno'] = $this->request->post['module_ecomkassa_sno'];
		} else {
			$data['sno'] = $this->config->get('module_ecomkassa_sno');
		}
		if (isset($this->request->post['module_ecomkassa_inn'])) {
			$data['inn'] = $this->request->post['module_ecomkassa_inn'];
		} else {
			$data['inn'] = $this->config->get('module_ecomkassa_inn');
		}
		if (isset($this->request->post['module_ecomkassa_vat'])) {
			$data['vat'] = $this->request->post['module_ecomkassa_vat'];
		} else {
			$data['vat'] = $this->config->get('module_ecomkassa_vat');
		}
		
		
		if (isset($this->request->post['module_ecomkassa_login'])) {
			$data['login'] = $this->request->post['module_ecomkassa_login'];
		} else {
			$data['login'] = $this->config->get('module_ecomkassa_login');
		}
		
		if (isset($this->request->post['module_ecomkassa_password'])) {
			$data['password'] = $this->request->post['module_ecomkassa_password'];
		} else {
			$data['password'] = $this->config->get('module_ecomkassa_password');
		}
		
		if (isset($this->request->post['module_ecomkassa_shopid'])) {
			$data['shopid'] = $this->request->post['module_ecomkassa_shopid'];
		} else {
			$data['shopid'] = $this->config->get('module_ecomkassa_shopid');
		}
		
		if (isset($this->request->post['module_ecomkassa_payment'])) {
			$data['module_ecomkassa_payment'] = $this->request->post['module_ecomkassa_payment'];
		} else {
			$data['module_ecomkassa_payment'] = $this->config->get('module_ecomkassa_payment');
		}
 
		 
		if (isset($this->request->post['module_ecomkassa_status'])) {
			$data['module_ecomkassa_status'] = $this->request->post['module_ecomkassa_status'];
		} else {
			$data['module_ecomkassa_status'] = $this->config->get('module_ecomkassa_status');
		}
		...
		$this->response->setOutput($this->load->view('extension/module/ecomkassa', $data));
	}
	...
	protected function validate() {
		...
		if(empty($this->request->post['module_ecomkassa_inn'])){
